...
child_symptoms <- c("breathingProblem", "cough", "fever", "headache", "vomit", "weightLoss")
...
hm_male_child <- hm(non_spatial_cm, "Male Child (1m-11y) Deaths by Symptom\nSierra Leone 2019-2022", "fig-cm-heatmap", labels = TRUE, cod_order = "manual", cod_custom_order = cod_custom_order, symp_custom_order = child_symptoms, keep_only = TRUE, symptoms = child_symptoms, width = 6, height = 8)
hm_female_child <- hm(non_spatial_cf, "Female Child (1m-11y) Deaths by Symptom\nSierra Leone 2019-2022", "fig-cf-heatmap", labels = TRUE, cod_order = "manual", cod_custom_order = cod_custom_order, symp_custom_order = child_symptoms, keep_only = TRUE, symptoms = child_symptoms, width = 6, height = 8)
